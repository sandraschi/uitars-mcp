...
4. Start the server:
   ...
   uv run python -m uitars_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn uitars_mcp.server:app --port 10976
   ```
5. Open `http://localhost:10976` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/uitars-mcp/issues) |
