...
const BACKEND_NAME: &str = "uitars-mcp-backend.exe";
const BACKEND_PORT: u16 = 10976;
const BACKEND_TAG: &str = "uitars-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "UITARS_MCP_PORT";
const ENV_HOST: &str = "UITARS_MCP_HOST";
const ENV_TAURI: &str = "UITARS_MCP_TAURI";
